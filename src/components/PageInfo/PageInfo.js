      ...
      {openPopup && (
        <div className="page-info page-info-content rounded-box">
          ...
          <div
            ...
            style={{ display: popupLoaded ? "none" : "flex" }}
          >
          ...
          <div
            style={{ visibility: popupLoaded ? "visible" : "hidden" }}
          ...
          >
            <div className="contribution-info react-leaflet-info">
              ...
              <img
                src="https://react-leaflet.js.org/img/logo-title.svg"
            ...
            <div className="contribution-info">
              ...
              <div className="geojson-info">
                ...
                <a
                  href="https://datahub.io/core/geo-ne-admin1"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  datahub
            ...
            <div className="contribution-info">
              ...
              <ul className="info-list">
                ...
                <li>
                  ...
                  <a
                    href="https://codepen.io/code4food/pen/rLvggd"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    codepen
                  ...
                  by{" "}
                  <a
                    href="https://codepen.io/code4food"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Tuan Hoang
                ...
                <li>
                  ...
                  <a
                    href="https://codepen.io/jakob-e/pen/mKceA"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    codepen
            ...
            <div className="contribution-info">
              ...
              <ul className="info-list">
                ...
                <li>
                  As month slider:{" "}
                  <a
                    href="https://slider-react-component.vercel.app/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    rc-slider
                ...
                <li>
                  ...
                  <a
                    href="https://github.com/SatAgro/suntime"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    suntime
                  ...
                  ,{" "}
                  <a
                    href="https://dateutil.readthedocs.io/en/stable/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    dateutil
                  ...
                  , and{" "}
                  <a
                    href="https://pypi.org/project/timezonefinder/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    timezonefinder
            ...
            <div className="github-logo">
              <a
                href="https://github.com/JSerwatka/Bociek"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
