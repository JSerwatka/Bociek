                    ...
                    <div style={{visibility: popupLoaded ? "visible" : "hidden"}} onLoad={() => setPopupLoaded(true)}>
                        ...
                        <div className="contribution-info">
                            ...
                            <ul className="info-list">
                                ...
                                <li>
                                    Loading screen weather animation based on <a href="https://codepen.io/code4food/pen/rLvggd" target="_blank" rel="noopener noreferrer">codepen</a> by <a href="https://codepen.io/code4food" target="_blank" rel="noopener noreferrer">Tuan Hoang</a>
                                </li>
                                <li>
                                    Loading screen dots animation based on <a href="https://codepen.io/jakob-e/pen/mKceA" target="_blank" rel="noopener noreferrer">codepen</a> by <a href="https://codepen.io/jakob-e" target="_blank" rel="noopener noreferrer">jakob-e</a>
                                </li>
                            </ul>
                        </div>
                        <div className="contribution-info">
