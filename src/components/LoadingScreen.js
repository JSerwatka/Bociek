...
function LoadingScreen() {
    return (
        <div className="showbox">
            <div className="title">
                <p className="heading">Animated Weather Icons</p>
                <p> Inspired by awesome weather icons at <a href="http://www.shutterstock.com/pic.mhtml?id=57368320" target="_blank" rel="noopener noreferrer">shutterstock.com</a>.</p>
            </div>
